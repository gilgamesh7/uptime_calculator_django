"""
Django settings for calculate_sla_uptime project.
...
SECRET_KEY = 'django-insecure-1v@ma0e=d7rwpi(*1%xz*qe08&343*ji6-6k1*3l5*cnqcy)8&'
...
WSGI_APPLICATION = 'calculate_sla_uptime.wsgi.application'
